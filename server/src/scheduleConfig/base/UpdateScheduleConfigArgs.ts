...
@ArgsType()
class UpdateScheduleConfigArgs {
  @Field(() => ScheduleConfigWhereUniqueInput, { nullable: false })
  where!: ScheduleConfigWhereUniqueInput;
  @Field(() => ScheduleConfigUpdateInput, { nullable: false })
  data!: ScheduleConfigUpdateInput;
}

export { UpdateScheduleConfigArgs };
